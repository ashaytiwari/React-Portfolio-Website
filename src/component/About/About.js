        ...
        <Grid container>
          <Grid item xs={12} sm={5} md={5} lg={5} xl={5}>
            <div className={styles.aboutWrapper}>
              <div className={`${styles.imageWrapper} ${styles.aboutWrapper}`}>
                <img
          ...
          <Grid item xs={12} sm={7} md={7} lg={7} xl={7}>
            <div className={styles.progressSet}>
              {skillSet &&
                skillSet.map((item) => <ProgressBarComponent data={item} />)}
            </div>
          </Grid>
        </Grid>
      </div>
